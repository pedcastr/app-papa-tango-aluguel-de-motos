        ...
        if (isWeb) {
            ...
            Linking.canOpenURL(gmailAppUrl)
                ...
                .catch(err => {
                    ...
                    showMessage('Erro', 'Não foi possível abrir o aplicativo de email');
                });
        }
    };
        ...
        Linking.canOpenURL(url)
            .then(supported => {
                if (supported) {
                    ...
                    showMessage('Erro', 'Não foi possível abrir o PDF externamente');
                }
            })
            .catch(err => {
                console.error('Erro ao abrir PDF externamente:', err);
                showMessage('Erro', 'Não foi possível abrir o PDF');
            });
    };
